...
const translations = {
    ...
    ar: {
        ...
        safety: {
            title: "تعريف السلامة | Innovo",
            "header.title": "مرحبًا بكم في بوابة تعريف السلامة لدى INNOVO",
            "header.subtitle": "يرجى اختيار البرنامج الذي تريد زيارته.",
            "ventures.item1.label": "",
            "ventures.item1.title": "مشروعات الإمارات والمملكة العربية السعودية",
            "ventures.item1.copy": "لمشروعات الإنشاء في الإمارات والمملكة العربية السعودية.",
            "ventures.item2.label": "",
            "ventures.item2.title": "المشروعات المشتركة في المملكة المتحدة",
            "ventures.item2.copy": "لمشروعات الإنشاء في المملكة المتحدة.",
            "ventures.item3.label": "",
            "ventures.item3.title": "مشروعات مصر",
            "ventures.item3.copy": "لمشروعات الإنشاء في مصر.",
            "ventures.cta": "دخول البوابة"
        },
        quality: {
    ...
    hi: {
        ...
        safety: {
            title: "सेफ़्टी इंडक्शन | Innovo",
            "header.title": "INNOVO सेफ़्टी इंडक्शन पोर्टल में आपका स्वागत है",
            "header.subtitle": "कृपया वह वेंचर चुनें जिसे आप देखना चाहते हैं।",
            "ventures.item1.label": "",
            "ventures.item1.title": "यूएई व KSA प्रोजेक्ट्स",
            "ventures.item1.copy": "यूएई और KSA में ऑपरेशंस/कंस्ट्रक्शन प्रोजेक्ट्स के लिए।",
            "ventures.item2.label": "",
            "ventures.item2.title": "यूनाइटेड किंगडम प्रोजेक्ट्स",
            "ventures.item2.copy": "यूनाइटेड किंगडम में ऑपरेशंस/कंस्ट्रक्शन प्रोजेक्ट्स के लिए।",
            "ventures.item3.label": "",
            "ventures.item3.title": "मिस्र प्रोजेक्ट्स",
            "ventures.item3.copy": "मिस्र में ऑपरेशंस/कंस्ट्रक्शन प्रोजेक्ट्स के लिए।",
            "ventures.cta": "वेंचर खोलें"
        },
        quality: {
    ...
    ur: {
        ...
        safety: {
            title: "سیفٹی انڈکشن | Innovo",
            "header.title": "INNOVO سیفٹی انڈکشن پورٹل میں خوش آمدید",
            "header.subtitle": "براہ کرم وہ ونچر منتخب کریں جسے آپ دیکھنا چاہتے ہیں۔",
            "ventures.item1.label": "",
            "ventures.item1.title": "متحدہ عرب امارات اور سعودی عرب کے پروجیکٹس",
            "ventures.item1.copy": "متحدہ عرب امارات اور سعودی عرب میں تعمیراتی پروجیکٹس کے لیے۔",
            "ventures.item2.label": "",
            "ventures.item2.title": "برطانیہ کے پروجیکٹس",
            "ventures.item2.copy": "برطانیہ میں تعمیراتی پروجیکٹس کے لیے۔",
            "ventures.item3.label": "",
            "ventures.item3.title": "مصر پروجیکٹس",
            "ventures.item3.copy": "مصر میں تعمیراتی پروجیکٹس کے لیے۔",
            "ventures.cta": "ونچر کھولیں"
        },
        payment_claims: {
...
// Extra translations for the U.A.E & KSA induction flow
const extraTranslations = { ar: {}, hi: {}, ur: {} };

extraTranslations.ar["uae-ksa-induction"] = {
    title: "تعريف الإمارات والسعودية | Innovo",
    "header.title": "مرحبًا بكم في تعريف السلامة",
    "header.subtitle": "اتبع الخطوات أدناه لإكمال تعريف السلامة.",
    "sections.step1.title": "الخطوة 1: شاهد فيديو التعريف",
    "sections.step1.copy": "نود أن تشاهد فيديو قصير قبل وصولك إلى الموقع.",
    "sections.step2.title": "الخطوة 2: أكمل نموذج تعريف السلامة",
    "sections.step2.copy": "يرجى إكمال نموذج تعريف السلامة ببياناتك بعد ذلك.",
    "sections.qr.title": "رمز الاستجابة السريع",
    "sections.qr.copy": "ستحصل على رمز QR بعد إتمام الخطوتين لتقديمه عند الوصول.",
    "cta.start": "اضغط هنا لبدء تعريف السلامة"
};
extraTranslations.ar["uae-ksa-category"] = {
    title: "اختر الفئة | Innovo",
    "header.title": "شكرًا لمشاهدة الفيديو",
    "header.subtitle": "يرجى اختيار الفئة",
    "card.title": "مرحبًا بك في تعريف السلامة من Innovo",
    "card.copy": "إذا كنت زائرًا خارجيًا اضغط على زر الزائر. إذا كنت موظف Innovo اضغط على زر الموظف.",
    "btn.visitor": "زائر",
    "btn.employee": "موظف Innovo"
};
extraTranslations.ar["uae-ksa-visitor-form"] = {
    title: "نموذج تعريف السلامة للزوار | Innovo",
    "header.title": "نموذج تعريف السلامة للزوار",
    "header.subtitle": "لإكمال تعريف السلامة يرجى تعبئة النموذج أدناه.",
    "section.visitor.title": "تفاصيل الزائر",
    "section.agree.title": "الاتفاقيات",
    "section.visit.title": "الزيارة وجهات الاتصال",
    "section.emergency.title": "تفاصيل جهة اتصال الطوارئ",
    "field.site": "الرجاء اختيار الموقع الذي تزوره:",
    "field.site.placeholder": "اختر الموقع...",
    "field.first": "الاسم الأول:",
    "field.first.placeholder": "اكتب اسمك الأول",
    "field.last": "اسم العائلة:",
    "field.last.placeholder": "اكتب اسم العائلة",
    "field.mobile": "رقم الجوال:",
    "field.mobile.placeholder": "مثال: 0555555555",
    "field.email": "البريد الإلكتروني:",
    "field.email.placeholder": "you@example.com",
    "field.company": "اسم الشركة:",
    "field.company.placeholder": "اسم شركتك",
    "field.position": "الوظيفة:",
    "field.position.placeholder": "المسمى الوظيفي",
    "agree.privacy": "سياسة الخصوصية للبيانات",
    "agree.privacy.copy": "أوافق على مشاركة معلوماتي مع Innovo.",
    "agree.safety": "اتفاقية تعريف السلامة",
    "agree.safety.copy": "أوافق على الالتزام بجميع إجراءات السلامة أثناء الزيارة.",
    "visit.datetime": "تاريخ ووقت الزيارة القادمة",
    "contact.site": "جهة الاتصال بالموقع (Innovo):",
    "contact.site.note": "جهة الاتصال في الموقع:",
    "contact.person": "رقم جهة الاتصال:",
    "contact.person.placeholder": "مثال: 0555555555",
    "contact.email": "البريد الإلكتروني لجهة الاتصال:",
    "contact.email.placeholder": "contact@example.com",
    "visit.purpose": "غرض الزيارة:",
    "visit.purpose.placeholder": "يرجى وصف غرض زيارتك...",
    "emergency.person": "جهة الاتصال للطوارئ:",
    "emergency.number": "رقم الطوارئ:",
    "emergency.number.placeholder": "مثال: 0555555555",
    "btn.back": "رجوع",
    "btn.next": "التالي",
    "human.title": "التحقق البشري",
    "human.note": "يرجى إكمال reCAPTCHA للمتابعة."
};
extraTranslations.ar["uae-ksa-employee-form"] = {
    title: "نموذج تعريف السلامة للموظفين | Innovo",
    "header.title": "نموذج تعريف السلامة للموظفين",
    "header.subtitle": "لإكمال تعريف السلامة يرجى تعبئة النموذج أدناه.",
    "section.employee.title": "تفاصيل الموظف",
    "section.agree.title": "الاتفاقيات",
    "section.visit.title": "توقيت الزيارة",
    "field.empnum": "رقم الموظف:",
    "field.empnum.placeholder": "اكتب رقم الموظف",
    "field.site": "الرجاء اختيار الموقع الذي تزوره:",
    "field.site.placeholder": "اختر الموقع...",
    "field.siteContact": "جهة الاتصال في الموقع:",
    "field.siteContact.placeholder": "اكتب جهة الاتصال",
    "field.siteContactNumber": "رقم جهة الاتصال:",
    "field.siteContactNumber.placeholder": "مثال: 0555555555",
    "field.siteContactEmail": "بريد جهة الاتصال:",
    "field.siteContactEmail.placeholder": "name@innovogroup.com",
    "field.purpose": "غرض الزيارة:",
    "field.purpose.placeholder": "يرجى وصف غرض زيارتك...",
    "agree.privacy": "سياسة الخصوصية للبيانات",
    "agree.privacy.copy": "أوافق على مشاركة معلوماتي مع Innovo Engineering and Contracting LLC.",
    "agree.safety": "اتفاقية تعريف السلامة",
    "agree.safety.copy": "أوافق على الالتزام بجميع إجراءات السلامة أثناء الزيارة.",
    "visit.datetime": "تاريخ ووقت الزيارة القادمة",
    "btn.back": "رجوع",
...
extraTranslations.ar["uae-ksa-qr"] = {
    title: "إتمام التعريف | Innovo",
    "header.title": "تمت الموافقة على دخولك للموقع",
    "header.subtitle": "اعرض هذا الرمز عند البوابة. تذكر: الخوذة، سترة عاكسة، وحذاء السلامة إلزامية.",
    "card.done.eyebrow": "تم إكمال التعريف",
    "card.done.title": "شكرًا لالتزامك بالسلامة.",
    "card.done.copy": "حافظ على معدات الوقاية: الخوذة، السترة العاكسة، وحذاء السلامة.",
    "qr.title": "رمز الدخول",
    "qr.note": "قدّم هذا الرمز عند البوابة واحتفظ ببطاقتك التعريفية.",
    "btn.download": "تحميل الرمز",
    "btn.home": "الرئيسية",
    "btn.back": "رجوع"
};
extraTranslations.ar["uae-ksa-video"] = {
    title: "فيديو التعريف | Innovo",
    "video.header.title": "سلامتك أولويتنا",
    "video.header.subtitle": "هذا الفيديو جزء من تعريف السلامة. بعد المشاهدة، أكمل نموذج تعريف السلامة.",
    "video.card.title": "فيديو تعريف السلامة",
    "video.card.note": "يرجى مشاهدة الفيديو كاملًا. التقديم أو التسريع غير مفعّل.",
    "video.btn.next": "التالي"
};

extraTranslations.hi["uae-ksa-induction"] = {
    title: "यूएई और केएसए इंडक्शन | Innovo",
    "header.title": "Innovo सेफ़्टी इंडक्शन में आपका स्वागत है",
    "header.subtitle": "अपना सेफ़्टी इंडक्शन पूरा करने के लिए ये कदम फ़ॉलो करें।",
    "sections.step1.title": "स्टेप 1: इंडक्शन वीडियो देखें",
    "sections.step1.copy": "साइट पर आने से पहले कृपया एक छोटा वीडियो देखें।",
    "sections.step2.title": "स्टेप 2: सेफ़्टी इंडक्शन फ़ॉर्म भरें",
    "sections.step2.copy": "इसके बाद अपनी जानकारी के साथ सेफ़्टी इंडक्शन फ़ॉर्म भरें।",
    "sections.qr.title": "आपका QR कोड",
    "sections.qr.copy": "दोनों चरण पूरे करने के बाद आपको एक QR कोड मिलेगा जिसे गेट पर दिखाना होगा।",
    "cta.start": "सेफ़्टी इंडक्शन शुरू करें"
};
extraTranslations.hi["uae-ksa-category"] = {
    title: "श्रेणी चुनें | Innovo",
    "header.title": "वीडियो देखने के लिए धन्यवाद",
    "header.subtitle": "कृपया श्रेणी चुनें",
    "card.title": "Innovo सेफ़्टी इंडक्शन में स्वागत है",
    "card.copy": "यदि आप बाहरी विज़िटर हैं तो Visitor बटन दबाएँ। यदि आप Innovo कर्मचारी हैं तो Innovo Employee बटन दबाएँ।",
    "btn.visitor": "विज़िटर",
    "btn.employee": "Innovo कर्मचारी"
};
extraTranslations.hi["uae-ksa-visitor-form"] = {
    title: "विज़िटर सेफ़्टी इंडक्शन फ़ॉर्म | Innovo",
    "header.title": "विज़िटर सेफ़्टी इंडक्शन फ़ॉर्म",
    "header.subtitle": "सेफ़्टी इंडक्शन पूरा करने के लिए कृपया यह फ़ॉर्म भरें।",
    "section.visitor.title": "विज़िटर विवरण",
    "section.agree.title": "समझौते",
    "section.visit.title": "विज़िट और संपर्क",
    "section.emergency.title": "आपात संपर्क विवरण",
    "field.site": "आप किस साइट पर जा रहे हैं:",
    "field.site.placeholder": "साइट चुनें...",
    "field.first": "पहला नाम:",
    "field.first.placeholder": "अपना पहला नाम लिखें",
    "field.last": "अंतिम नाम:",
    "field.last.placeholder": "अपना अंतिम नाम लिखें",
    "field.mobile": "मोबाइल नंबर:",
    "field.mobile.placeholder": "उदा. 0555555555",
    "field.email": "ईमेल:",
    "field.email.placeholder": "you@example.com",
    "field.company": "कंपनी का नाम:",
    "field.company.placeholder": "अपनी कंपनी का नाम",
    "field.position": "पद:",
    "field.position.placeholder": "अपना पद लिखें",
    "agree.privacy": "डेटा प्राइवेसी पॉलिसी",
    "agree.privacy.copy": "मैं अपनी जानकारी Innovo के साथ साझा करने के लिए सहमत हूँ।",
    "agree.safety": "सेफ़्टी इंडक्शन एग्रीमेंट",
    "agree.safety.copy": "मैं साइट विज़िट के दौरान सभी सेफ़्टी प्रक्रियाओं का पालन करने के लिए सहमत हूँ।",
    "visit.datetime": "आगामी विज़िट की तारीख और समय",
    "contact.site": "साइट संपर्क (Innovo):",
    "contact.site.note": "साइट पर Innovo संपर्क:",
    "contact.person": "संपर्क व्यक्ति का नंबर:",
    "contact.person.placeholder": "उदा. 0555555555",
    "contact.email": "साइट संपर्क ईमेल:",
    "contact.email.placeholder": "contact@example.com",
    "visit.purpose": "विज़िट का उद्देश्य:",
    "visit.purpose.placeholder": "कृपया अपनी विज़िट का उद्देश्य बताइए...",
    "emergency.person": "आपात संपर्क व्यक्ति:",
    "emergency.number": "आपात नंबर:",
    "emergency.number.placeholder": "उदा. 0555555555",
    "btn.back": "वापस",
    "btn.next": "आगे",
    "human.title": "मानव सत्यापन",
    "human.note": "जारी रखने के लिए reCAPTCHA पूरा करें।"
};
extraTranslations.hi["uae-ksa-employee-form"] = {
    title: "कर्मचारी सेफ़्टी इंडक्शन फ़ॉर्म | Innovo",
    "header.title": "कर्मचारी सेफ़्टी इंडक्शन फ़ॉर्म",
    "header.subtitle": "सेफ़्टी इंडक्शन पूरा करने के लिए कृपया यह फ़ॉर्म भरें।",
    "section.employee.title": "कर्मचारी विवरण",
    "section.agree.title": "समझौते",
    "section.visit.title": "विज़िट समय",
    "field.empnum": "कर्मचारी संख्या:",
    "field.empnum.placeholder": "अपना कर्मचारी नंबर लिखें",
    "field.site": "आप किस साइट पर जा रहे हैं:",
    "field.site.placeholder": "साइट चुनें...",
    "field.siteContact": "साइट संपर्क:",
    "field.siteContact.placeholder": "साइट संपर्क दर्ज करें",
    "field.siteContactNumber": "संपर्क नंबर:",
    "field.siteContactNumber.placeholder": "उदा. 0555555555",
    "field.siteContactEmail": "संपर्क ईमेल:",
    "field.siteContactEmail.placeholder": "name@innovogroup.com",
    "field.purpose": "विज़िट का उद्देश्य:",
    "field.purpose.placeholder": "कृपया अपनी विज़िट का उद्देश्य बताइए...",
    "agree.privacy": "डेटा प्राइवेसी पॉलिसी",
    "agree.privacy.copy": "मैं अपनी जानकारी Innovo Engineering and Contracting LLC के साथ साझा करने के लिए सहमत हूँ।",
    "agree.safety": "सेफ़्टी इंडक्शन एग्रीमेंट",
    "agree.safety.copy": "मैं विज़िट के दौरान सभी सेफ़्टी प्रक्रियाओं का पालन करने के लिए सहमत हूँ।",
    "visit.datetime": "आगामी विज़िट की तारीख और समय",
    "btn.back": "वापस",
    "btn.next": "आगे",
    "human.title": "मानव सत्यापन",
...
extraTranslations.hi["uae-ksa-qr"] = {
    title: "इंडक्शन पूरा | Innovo",
    "header.title": "आपको साइट प्रवेश की अनुमति है",
    "header.subtitle": "इस QR को गेट पर दिखाएँ। ध्यान रखें: हार्ड हैट, हाई-विज वेस्ट, सेफ़्टी बूट अनिवार्य हैं।",
    "card.done.eyebrow": "इंडक्शन पूर्ण",
    "card.done.title": "सुरक्षा को प्राथमिकता देने के लिए धन्यवाद।",
    "card.done.copy": "अपना PPE पहनें: हार्ड हैट, हाई-विज वेस्ट, सेफ़्टी बूट।",
    "qr.title": "आपका साइट QR",
    "qr.note": "यह QR गेट पर दिखाएँ और अपनी आईडी तैयार रखें।",
    "btn.download": "QR डाउनलोड करें",
    "btn.home": "होम",
    "btn.back": "वापस"
};

extraTranslations.hi["uae-ksa-video"] = {
    title: "इंडक्शन वीडियो | Innovo",
    "video.header.title": "आपकी सुरक्षा हमारी प्राथमिकता है",
    "video.header.subtitle": "यह वीडियो आपके सेफ़्टी ओरिएंटेशन का हिस्सा है। वीडियो देखने के बाद सेफ़्टी इंडक्शन फॉर्म भरें।",
    "video.card.title": "सेफ़्टी इंडक्शन वीडियो",
    "video.card.note": "पूरा वीडियो देखें। फास्ट-फॉरवर्ड/सीक अक्षम है।",
    "video.btn.next": "आगे"
};

extraTranslations.ur["uae-ksa-induction"] = {
    title: "متحدہ عرب امارات اور سعودی انڈکشن | Innovo",
    "header.title": "Innovo سیفٹی انڈکشن میں خوش آمدید",
    "header.subtitle": "سیفٹی انڈکشن مکمل کرنے کے لیے یہ مراحل فالو کریں۔",
    "sections.step1.title": "مرحلہ 1: انڈکشن ویڈیو دیکھیں",
    "sections.step1.copy": "سائٹ پر آنے سے پہلے ایک مختصر ویڈیو دیکھیں۔",
    "sections.step2.title": "مرحلہ 2: سیفٹی انڈکشن فارم پُر کریں",
    "sections.step2.copy": "بعد میں اپنی معلومات کے ساتھ سیفٹی انڈکشن فارم پُر کریں۔",
    "sections.qr.title": "آپ کا QR کوڈ",
    "sections.qr.copy": "دونوں مراحل مکمل کرنے کے بعد آپ کو ایک QR کوڈ ملے گا جو گیٹ پر دکھانا ہوگا۔",
    "cta.start": "سیفٹی انڈکشن شروع کریں"
};
extraTranslations.ur["uae-ksa-category"] = {
    title: "زمرہ منتخب کریں | Innovo",
    "header.title": "ویڈیو دیکھنے کا شکریہ",
    "header.subtitle": "براہ کرم زمرہ منتخب کریں",
    "card.title": "Innovo سیفٹی انڈکشن میں خوش آمدید",
    "card.copy": "اگر آپ بیرونی وزیٹر ہیں تو Visitor بٹن دبائیں۔ اگر آپ Innovo ملازم ہیں تو Innovo Employee بٹن دبائیں۔",
    "btn.visitor": "وزیٹر",
    "btn.employee": "Innovo ملازم"
};
extraTranslations.ur["uae-ksa-visitor-form"] = {
    title: "وزیٹر سیفٹی انڈکشن فارم | Innovo",
    "header.title": "وزیٹر سیفٹی انڈکشن فارم",
    "header.subtitle": "سیفٹی انڈکشن مکمل کرنے کے لیے براہ کرم فارم پُر کریں۔",
    "section.visitor.title": "وزیٹر کی تفصیلات",
    "section.agree.title": "معاہدے",
    "section.visit.title": "وزٹ اور رابطے",
    "section.emergency.title": "ایمرجنسی رابطہ تفصیلات",
    "field.site": "آپ کون سی سائٹ پر جا رہے ہیں:",
    "field.site.placeholder": "سائٹ منتخب کریں...",
    "field.first": "پہلا نام:",
    "field.first.placeholder": "اپنا پہلا نام لکھیں",
    "field.last": "آخری نام:",
    "field.last.placeholder": "اپنا آخری نام لکھیں",
    "field.mobile": "موبائل نمبر:",
    "field.mobile.placeholder": "مثال: 0555555555",
    "field.email": "ای میل:",
    "field.email.placeholder": "you@example.com",
    "field.company": "کمپنی کا نام:",
    "field.company.placeholder": "اپنی کمپنی کا نام",
    "field.position": "عہدہ:",
    "field.position.placeholder": "اپنا عہدہ لکھیں",
    "agree.privacy": "ڈیٹا پرائیویسی پالیسی",
    "agree.privacy.copy": "میں اپنی معلومات Innovo کے ساتھ شیئر کرنے پر رضامند ہوں۔",
    "agree.safety": "سیفٹی انڈکشن معاہدہ",
    "agree.safety.copy": "میں وزٹ کے دوران تمام حفاظتی طریقہ کار پر عمل کرنے پر متفق ہوں۔",
    "visit.datetime": "آئندہ وزٹ کی تاریخ اور وقت",
    "contact.site": "سائٹ رابطہ (Innovo):",
    "contact.site.note": "سائٹ پر Innovo رابطہ:",
    "contact.person": "رابطہ نمبر:",
    "contact.person.placeholder": "مثال: 0555555555",
    "contact.email": "سائٹ رابطہ ای میل:",
    "contact.email.placeholder": "contact@example.com",
    "visit.purpose": "وزٹ کا مقصد:",
    "visit.purpose.placeholder": "براہ کرم وزٹ کا مقصد بیان کریں...",
    "emergency.person": "ایمرجنسی رابطہ شخص:",
    "emergency.number": "ایمرجنسی نمبر:",
    "emergency.number.placeholder": "مثال: 0555555555",
    "btn.back": "واپس",
    "btn.next": "اگلا",
    "human.title": "انسانی تصدیق",
    "human.note": "جاری رکھنے کے لیے reCAPTCHA مکمل کریں۔"
};
extraTranslations.ur["uae-ksa-employee-form"] = {
    title: "ملازمین کا سیفٹی انڈکشن فارم | Innovo",
    "header.title": "ملازمین کا سیفٹی انڈکشن فارم",
    "header.subtitle": "سیفٹی انڈکشن مکمل کرنے کے لیے براہ کرم فارم پُر کریں۔",
    "section.employee.title": "ملازم کی تفصیلات",
    "section.agree.title": "معاہدے",
    "section.visit.title": "وزٹ کا وقت",
    "field.empnum": "ملازم نمبر:",
    "field.empnum.placeholder": "ملازم نمبر درج کریں",
    "field.site": "آپ کون سی سائٹ پر جا رہے ہیں:",
    "field.site.placeholder": "سائٹ منتخب کریں...",
    "field.siteContact": "سائٹ رابطہ:",
    "field.siteContact.placeholder": "سائٹ رابطہ درج کریں",
    "field.siteContactNumber": "رابطہ نمبر:",
    "field.siteContactNumber.placeholder": "مثال: 0555555555",
    "field.siteContactEmail": "رابطہ ای میل:",
    "field.siteContactEmail.placeholder": "name@innovogroup.com",
    "field.purpose": "وزٹ کا مقصد:",
    "field.purpose.placeholder": "براہ کرم وزٹ کا مقصد بیان کریں...",
    "agree.privacy": "ڈیٹا پرائیویسی پالیسی",
    "agree.privacy.copy": "میں اپنی معلومات Innovo Engineering and Contracting LLC کے ساتھ شیئر کرنے پر رضامند ہوں۔",
    "agree.safety": "سیفٹی انڈکشن معاہدہ",
    "agree.safety.copy": "میں وزٹ کے دوران تمام حفاظتی طریقہ کار پر عمل کرنے پر متفق ہوں۔",
    "visit.datetime": "آئندہ وزٹ کی تاریخ اور وقت",
    "btn.back": "واپس",
...
extraTranslations.ur["uae-ksa-qr"] = {
    title: "انڈکشن مکمل | Innovo",
    "header.title": "آپ کو سائٹ میں داخلے کی منظوری مل گئی",
    "header.subtitle": "یہ QR گیٹ پر دکھائیں۔ یاد رکھیں: ہیلمٹ، ہائی وِز جیکٹ، اور سیفٹی بوٹ لازمی ہیں۔",
    "card.done.eyebrow": "انڈکشن مکمل",
    "card.done.title": "حفاظت کو ترجیح دینے کا شکریہ۔",
    "card.done.copy": "اپنا PPE پہنیں: ہیلمٹ، ہائی وِز جیکٹ، سیفٹی بوٹ۔",
    "qr.title": "آپ کا سائٹ QR",
    "qr.note": "یہ QR گیٹ پر دکھائیں اور اپنی شناخت تیار رکھیں۔",
    "btn.download": "QR ڈاؤن لوڈ کریں",
    "btn.home": "ہوم",
    "btn.back": "واپس"
};
extraTranslations.ur["uae-ksa-video"] = {
    title: "انڈکشن ویڈیو | Innovo",
    "video.header.title": "آپ کی حفاظت ہماری ترجیح ہے",
    "video.header.subtitle": "یہ ویڈیو آپ کی سیفٹی اورینٹیشن کا حصہ ہے۔ ویڈیو دیکھنے کے بعد سیفٹی انڈکشن فارم پُر کریں۔",
    "video.card.title": "سیفٹی انڈکشن ویڈیو",
    "video.card.note": "براہ کرم ویڈیو مکمل دیکھیں۔ فارورڈ/سیِک غیر فعال ہے۔",
    "video.btn.next": "اگلا"
};

['ar', 'hi', 'ur'].forEach((lng) => {
    if (translations[lng] && extraTranslations[lng]) {
        Object.assign(translations[lng], extraTranslations[lng]);
    }
});
